  ...
  return (
    <div className="termsandconditionspage">
      ...
      <div className="terms-and-conditions-parent">
        ...
        <div className="please-refer-to-our-terms-and-wrapper">
      ...
      <main className="footer-content">
        ...
        <section className="third-party-services-parent">
        ...
        <section className="your-choices-parent">
        ...
        <section className="changes-to-this-privacy-policy-parent">
